$_mod.def("/MarkoBaseTemplate$0.0.1/src/components/click-count/index", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko-widgets$6.6.2/lib/index-browser'/*'marko-widgets'*/).defineComponent({
    /**
     * The template to use as the view
     */
    template: require('/MarkoBaseTemplate$0.0.1/src/components/click-count/template.marko'/*'./template.marko'*/),
