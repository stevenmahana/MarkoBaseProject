$_mod.def("/MarkoBaseTemplate$0.0.1/src/components/form-select-state/index", function(require, exports, module, __filename, __dirname) { var request = require('/browser-request$0.3.3/index'/*'request'*/);

module.exports = require('/marko-widgets$6.6.2/lib/index-browser'/*'marko-widgets'*/).defineComponent({
    template: require('/MarkoBaseTemplate$0.0.1/src/components/form-select-state/template.marko'/*'./template.marko'*/),
