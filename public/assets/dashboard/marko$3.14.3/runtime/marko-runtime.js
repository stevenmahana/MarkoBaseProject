$_mod.def("/marko$3.14.3/runtime/marko-runtime", function(require, exports, module, __filename, __dirname) { /*
...
var helpers = require('/marko$3.14.3/runtime/helpers'/*'./helpers'*/);
...
var stream = require('/marko$3.14.3/runtime/stream/index-browser'/*'./stream'*/);
...
Template.prototype = {
    ...
    render: function(data, out, callback) {
        if(typeof out === 'function') {
            require('/marko$3.14.3/runtime/deprecate'/*'./deprecate'*/).warn(
...
require('/marko$3.14.3/runtime/deprecate'/*'./deprecate'*/)(
    Template.prototype,
    'renderSync',
...
if (stream) {
    ...
    require('/raptor-util$2.0.1/inherit'/*'raptor-util/inherit'*/)(Readable, stream.Readable);
}
...
loader = require('/marko$3.14.3/runtime/loader/index-browser'/*'./loader'*/);
