$_mod.def("/marko-widgets$6.6.2/taglib/widget-tag", function(require, exports, module, __filename, __dirname) { /*
...
'use strict';
var markoWidgets = require('/marko-widgets$6.6.2/lib/index-browser'/*'../'*/);
var extend = require('/raptor-util$2.0.1/extend'/*'raptor-util/extend'*/);
var widgetArgsId = require('/marko-widgets$6.6.2/lib/widget-args-id'/*'../lib/widget-args-id'*/);
var widgetBodyHelper = require('/marko-widgets$6.6.2/taglib/helpers/widgetBody'/*'./helpers/widgetBody'*/);
...
function preserveWidgetEl(existingWidget, out, widgetsContext, widgetBody) {
    ...
    widgetsContext.globalWidgetsContext.addPreservedDOMNode(existingWidget.el, null, hasUnpreservedBody); // Mark the element as being preserved (for morphdom)
}
...
module.exports = function render(input, out) {
    ...
    if (!global.__widgetsBeginAsyncAdded) {
        ...
        out.on('beginAsync', function(event) {
            ...
            var asyncOut = event.writer;

            var widgetsContext = markoWidgets.getWidgetsContext(parentAsyncWriter);
            ...
            // parent block.
            var widgetStack = widgetsContext.widgetStack;
            var nestedWidgetsContext = new markoWidgets.WidgetsContext(out, widgetStack[widgetStack.length-1]);
            asyncOut.data.widgets = nestedWidgetsContext;

            asyncOut.data.widgetArgs = parentAsyncWriter.data.widgetArgs;
        });
    }
