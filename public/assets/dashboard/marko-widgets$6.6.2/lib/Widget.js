$_mod.def("/marko-widgets$6.6.2/lib/Widget", function(require, exports, module, __filename, __dirname) { /*
 ...
 */
var inherit = require('/raptor-util$2.0.1/inherit'/*'raptor-util/inherit'*/);
...
var arrayFromArguments = require('/raptor-util$2.0.1/arrayFromArguments'/*'raptor-util/arrayFromArguments'*/);
...
function hasCompatibleWidget(globalWidgetsContext, existingWidget) {
    var id = existingWidget.id;
    var newWidgetDef = globalWidgetsContext.getWidget(id);
    if (!newWidgetDef) {
        return false;
    }
    ...
    rerender: function(props) {
        ...
        updateManager.batchUpdate(function() {
            ...
            function onBeforeElUpdated(fromEl, toEl) {
                ...
                if (globalWidgetsContext && id) {
                    if (globalWidgetsContext.isPreservedEl(id)) {

                        if (globalWidgetsContext.hasUnpreservedBody(id)) {
                        ...
                        existingWidget = fromEl.__widget;
                        if (existingWidget && !hasCompatibleWidget(globalWidgetsContext, existingWidget)) {
            ...
            function onBeforeElChildrenUpdated(el) {
                if (globalWidgetsContext && el.id) {
                    if (globalWidgetsContext.isPreservedBodyEl(el.id)) {
