$_mod.def("/async-writer$2.1.3/src/AsyncStream", function(require, exports, module, __filename, __dirname) { 'use strict';var process=require("process"); 

var EventEmitter = require('/events$1.1.1/events'/*'events'*/).EventEmitter;
var StringWriter = require('/async-writer$2.1.3/src/StringWriter'/*'./StringWriter'*/);
var BufferedWriter = require('/async-writer$2.1.3/src/BufferedWriter'/*'./BufferedWriter'*/);
